...
import com.sky.skyrpc.bootstrap.ProviderBootStrap;
...
public class ProviderExample {
    ...
    public static void main(String[] args) {
        ...
        ServiceRegisterInfo registerInfo = new ServiceRegisterInfo(UserService.class.getName(),UserServiceImpl.class);
        serviceRegisterInfoList.add(registerInfo);
